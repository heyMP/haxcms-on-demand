import { v as visit, B as BREAK, p as print, a as parser$1 } from './common/parser-fc72f5d3.js';
...
function assertIdValue(idValue) {
     invariant(isIdValue(idValue), "Encountered a sub-selection on the query, but the store doesn't have an object reference. This should never happen during normal use unless you have custom code that is directly manipulating the store; please file an issue.");
}
...
var parser = getCjsExportFromNamespace(parser$1);
...
export { ApolloClient, ApolloError, ApolloLink, FetchType, HeuristicFragmentMatcher, HttpLink, InMemoryCache, IntrospectionFragmentMatcher, NetworkStatus, ObjectCache, Observable, ObservableQuery, StoreReader, StoreWriter, WriteError, assertIdValue, concat, createOperation, defaultDataIdFromObject, defaultNormalizedCacheFactory$1 as defaultNormalizedCacheFactory, empty, enhanceErrorWithDocument, execute, from, fromError, fromPromise, getOperationName, src as gql, isApolloError, makePromise, split, toPromise };
